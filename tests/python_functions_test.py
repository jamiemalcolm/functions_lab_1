...
#   @unittest.skip("delete this line to run the test")
  def test_volume_of_cube(self):
    #add test code here
      volume_value = find_volume(10)
      self.assertEqual(1000, volume_value)
    # pass
...
#   @unittest.skip("delete this line to run the test")
  def test_reverse_string(self):
    #add test code here
    string = "dog"
    string_reversed = reversed_string(string)
    self.assertEqual("god", string_reversed)
    # pass
...
#   @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
      degree = 32
      celsius_value = temp_converter(degree)
      self.assertEqual(0, celsius_value)
    #add test code here
    #pass
